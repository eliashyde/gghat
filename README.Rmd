...
functions to be used with the text and errorbar geoms.You can install the development version of gghat from [GitHub](https://github.com/eliashyde/gghat). Obviously, gghat also requires that ggplot is installed. 
In fact, I would recommend that the user installs the entire tidyverse, as it contains a host of useful packages.
